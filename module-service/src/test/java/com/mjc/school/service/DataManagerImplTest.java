...
class DataManagerImplTest {
    ...
    public static void setUp() {
        ...
        manager = new DataManagerImpl(new DataSourceImpl(authors, news));
    }
    ...
    void getNews() {
        ...
        System.out.println();
        List<NewsDTO> news = manager.getNews();
        assertEquals(expectedListSize, news.size());
    }

    @Test
    void getNewsById() throws SearchNewsException {
        NewsDTO newsByIdOne = manager.getNewsById(1);
        NewsDTO newsByIdTwo = manager.getNewsById(2);
    ...
    void removeNews() {
        ...
        assertThrows(SearchNewsException.class, () -> manager.getNewsById(1));
    }
}